...
import "github.com/dyegocaldeira/fleet-freight-calculator/internal/freight/entity"
...
func (c *CreateRouteUseCase) Execute(input CreateRouteInput) (*CreateRouteOutput, error) {
